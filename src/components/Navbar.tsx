    ...
    <nav style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 0 }}>
        ...
        <div style={{ marginLeft: 10 }}>
          <div style={{ fontSize: 16, fontWeight: 500, letterSpacing: '0.18em', color: 'var(--text)', lineHeight: 1 }}>CUERATE</div>
          <div style={{ fontSize: 7, fontWeight: 300, letterSpacing: '0.22em', color: 'var(--text-sec)', marginTop: 3 }}>DJ COMPANION</div>
        </div>
      </div>
              ...
              {showMenu && (
                <div style={{
                  ...
                  <Link href="/profile" onClick={() => setShowMenu(false)} style={{
                    ...
                    color: 'var(--text)', fontSize: 14, textDecoration: 'none', borderRadius: 6,
                  }}>
                    My profile
                  </Link>
